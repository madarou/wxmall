    	 ...
    	 if(showHandle_Id==0){
    		 ...
    		 $.ajax({
       		  type: "POST",
     	          ...
     	          url: "/product/sdelete/"+$("#loginUserId").val()+"/?token="+$("#loginToken").val(),
     	          dataType: "json",
	...
	<!-- 搜索 -->
     ...
     $("#search").click(function(){
		 ...
		 if(content.length==0){
       	 ...
       	 window.location="/product/searchrep/"+$("#loginUserId").val()+"?token="+$("#loginToken").val()+"&keyword="+content;
       });
     });
     </script>
     <!-- 搜索 -->
     <section style="text-align:right">
      <input type="text" class=" textbox_225 length_input_20" placeholder="海南西红柿" id="namep"/>
