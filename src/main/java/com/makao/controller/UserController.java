					...
					+ "<html>"
						+ "<head>"
							...
							+ "<style>"
								...
								+".zhui{position: absolute;display: inline-block; right:10%;top:5%; text-align:center;color: white;border: 2px solid white;padding: 0.3em 0.6em;border-radius: 0.3rem;background-color: #6DBFD5;}"
							+"</style>"
						+ "</head>"
						+ "<body>"
							+"<div class=\"flash\" id=\"flash\"><input id=\"jump\" type=\"button\" value=\"跳过(2s)\" class=\"zhui\" onclick=\"disp();\"></input></div>"
