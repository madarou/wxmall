					...
					+ "<html>"
						+ "<head>"
							...
							+ "<style>"
								...
								+".jumpcss{position: absolute;display: inline-block;right:10%;top:5%;text-align:center;border-radius: 2px;color: white;border: 2px solid white;padding: 0.3em 0.6em;}"
							+"</style>"
						+ "</head>"
						+ "<body>"
