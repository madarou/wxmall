			...
			page = "<!DOCTYPE html>"
					+ "<html>"
						...
						+ "<body>"
							...
							+"<div style=\"background:url(\"/img/opening.png\") no-repeat center bottom !important;display:none\" id=\"flash2\"><input id=\"jump\" type=\"button\" value=\"跳过(2s)\" onclick=\"disp();\"/></div>"
