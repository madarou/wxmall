			...
			page = "<!DOCTYPE html>"
					+ "<html>"
						+ "<head>"
							...
							+ "<style>"
								+".flash{position:fixed;top:0;left:0;background-color:#77CFDD !important;width:100%;height:100%;z-index:99999;background:url(\"http://sx-1251508610.cosgz.myqcloud.com/img/opening.png\") no-repeat center !important;"
								+"background-size:100%}"
						...
						+ "<body>"
							...
							+ "<script src=\"http://sx-1251508610.cosgz.myqcloud.com/static/bundle.js\"></script>"
						+ "</body>"
					+ "</html>";
			out.write(page);
			out.flush();out.close();
