			...
			page = "<!DOCTYPE html>"
					+ "<html>"
						+ "<head>"
							...
							+ "<style>"
								+".flash{position:fixed;top:0;left:0;background-color:gray;width:100%;height:100%;z-index:99999;background:url(\"sx-1251508610.cosgz.myqcloud.com/img/opening.png\") no-repeat center bottom !important;"
