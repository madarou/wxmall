					...
					+ "<html>"
						+ "<head>"
							...
							+ "<style>"
								...
								+".jumpcss{position: absolute;display: inline-block;right:10%;top:5%;text-align:center;border-radius: 4px;color: white;border: 2px solid white;padding: 0.2em 0.4em;}"
							+"</style>"
						+ "</head>"
						+ "<body>"
