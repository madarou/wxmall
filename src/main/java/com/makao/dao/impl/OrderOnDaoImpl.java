...
//									ps.setString(27, rs.getString("senderPhone"));
									...
									ps.setString(2, p.getProductIds());
									ps.setString(3, p.getProductNames());
									ps.setTimestamp(4, p.getOrderTime());
									ps.setString(5, p.getReceiverName());
									ps.setString(6, p.getPhoneNumber());
									ps.setString(7, p.getAddress());
									ps.setString(8, p.getPayType());
									ps.setString(9, p.getReceiveType());
									ps.setString(10, p.getReceiveTime());
									ps.setInt(11, p.getCouponId());
									ps.setString(12, p.getCouponPrice());
									ps.setString(13, p.getTotalPrice());
									ps.setString(14, p.getFreight());
									ps.setString(15, p.getComment());
									ps.setString(16, p.getVcomment());
									ps.setString(17, OrderState.RECEIVED.getCode()+"");
									ps.setString(18, p.getCityarea());
									ps.setTimestamp(19, new Timestamp(System.currentTimeMillis()));
									ps.setInt(20, p.getUserId());
									ps.setInt(21, p.getAreaId());
									ps.setInt(22, p.getCityId());
									ps.setString(23, "无需退款");//正常完成的订单，退款状态为无
									ps.setString(24, p.getHistory()+","+OrderState.RECEIVED.getText()+"="+new Timestamp(System.currentTimeMillis()));
									ps.setInt(25, p.getPoint());
									ps.setString(26, p.getSender());
									ps.setString(27, p.getSenderPhone());
									ps.executeUpdate();
