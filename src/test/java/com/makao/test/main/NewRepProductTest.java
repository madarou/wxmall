 ...
 * @author makao
 * @date 2016年5月8日
 * 超级管理员给Product商品库添加商品，可以不要cityId和areaId
 */
public class NewRepProductTest {
...
//		String vendor = "{\"userName\":\"马靠\",\"areaId\":1,\"cityId\":1,\"cityName\":\"上海\",\"areaName\":\"张江\"}";
		...
		String newprodcut = "http://localhost:8080/product/snew/1";
		String product = "{\"productName\":\"海南千禧小番茄\",\"catalog\":\"水果\",\"label\":\"无标签\",\"price\":\"12.00\",\"standard\":\"一份足2斤\",\"marketPrice\":\"30.00\",\"inventory\":12,\"sequence\":3,\"status\":\"库存紧张\",\"origin\":\"海南\",\"salesVolume\":7637,\"likes\":3972}";
